        ...
        <div className='max-w-7xl mx-auto flex justify-between'>
            ...
            <div>
                <div className='sm:flex gap-8 pt-2 items-center hidden '>
                    <NavLink to='/challenges' className={({isActive})=> isActive ? "text-cyan-400 text-xl font-medium" : "text-slate-200 hover:text-cyan-500 transition-all duration-300 text-xl"}>Challenges</NavLink>
                    <NavLink to='/dashboard' className={({isActive})=> isActive ? "text-cyan-400 text-xl font-medium" : "text-slate-200 hover:text-cyan-500 transition-all duration-300 text-xl"} >Dashboard</NavLink>
                    <NavLink to='/leaderboard' className={({isActive})=> isActive ? "text-cyan-400 text-xl font-medium" : "text-slate-200 hover:text-cyan-500 transition-all duration-300 text-xl"}>Leaderboard</NavLink>
                </div>
            </div>
